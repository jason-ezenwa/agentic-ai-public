...
Only write a spec if explicitly asked. If asked, invoke the `/create-technical-spec` skill.
...
- Delegate planning, spec, or architectural work to another planning or tech-lead agent — do that work yourself; only delegate implementation, review, and testing to other agents
